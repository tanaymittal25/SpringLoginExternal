...
import com.howtodoinjava.demo.resource.AbstractEndpoint;
...
public class AuthorizationEndpoint extends AbstractEndpoint {
	...
	private static AuthorizationCodeServices authorizationCodeServices = new InMemoryAuthorizationCodeServices();
	...
	public static View getAuthorizationCodeResponse(AuthorizationRequest authorizationRequest, Authentication authUser) {
		try {
	...
	private static String generateCode(AuthorizationRequest authorizationRequest, Authentication authentication)
	...
	private static String getSuccessfulRedirect(AuthorizationRequest authorizationRequest, String authorizationCode) {
	...
	private static String getUnsuccessfulRedirect(AuthorizationRequest authorizationRequest, OAuth2Exception failure,
			boolean fragment) {
	...
	public void setAuthorizationCodeServices(AuthorizationCodeServices authorizationCodeServices) {
		AuthorizationEndpoint.authorizationCodeServices = authorizationCodeServices;
	}
